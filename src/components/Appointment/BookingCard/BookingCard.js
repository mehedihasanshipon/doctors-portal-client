...
const BookingCard = (props) => {
  ...
  return (
    <div className="col-md-6 col-lg-4 text-center g-3">
      <div className="bookCard p-4">
        ...
        <AppointmentForm  selectedDate={selectedDate} subject={subject} modalIsOpen={modalIsOpen} closeModal={closeModal} />
      </div>
    </div>
  );
};
